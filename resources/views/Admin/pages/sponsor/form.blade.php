...
<form action ="{{route('sponsor.store')}} "  method = "post" >
  ...
  <div class="form-group">
    ...
    <input required name="sponsor_type" type="textarea" class="form-control" id="exampleInputPassword1" placeholder="write the description">
    @error(sponsorType)
  <div class="alert alert-danger">{{message}}</div>
  @enderror
  </div>
  <div class="form-group">
    ...
    <input required name="sponsor_url" type="textarea" class="form-control" id="exampleInputPassword1" placeholder="write the description">
    @error(sponsorURL)
  <div class="alert alert-danger">{{message}}</div>
  @enderror
  </div>
